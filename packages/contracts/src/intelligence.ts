...
export const PmsPriceMonth = z.object({
...
export const LpgPriceMonth = z.object({
  period: monthStr,
  label: z.string(),
  sourceUrl: z.string().url(),
...
export const NmdpraMonth = z.object({
  month: monthStr,
  label: z.string(),
  sourceUrl: z.string().url(),
...
export const NmdpraDataset = z.object({
...
export const LomeDataset = z.object({
  generatedAt: z.string(),
  paradox: z.object({
    title: z.string(),
    statement: z.string(),
...
export const GantryDataset = z.object({
  generatedAt: z.string(),
  description: z.string(),
...
export const LpgMarketDataset = z.object({
  generatedAt: z.string(),
  demandMt: z.object({
    value: num,
    year: num,
...
export const JetDataset = z.object({
  generatedAt: z.string(),
...
export const PmsPriceDataset = z.object({
  generatedAt: z.string(),
  source: z.string(),
  months: z.array(PmsPriceMonth),
});

export const LpgPriceDataset = z.object({
  generatedAt: z.string(),
  source: z.string(),
  months: z.array(LpgPriceMonth),
});

/* ------------------------------ NMDPRA monthly ---------------------------- */

export type NmdpraDataset = z.infer<typeof NmdpraDataset>;
export type NmdpraMonth = z.infer<typeof NmdpraMonth>;
export type PmsPriceDataset = z.infer<typeof PmsPriceDataset>;
export type LpgPriceDataset = z.infer<typeof LpgPriceDataset>;
export type GantryDataset = z.infer<typeof GantryDataset>;
export type LomeDataset = z.infer<typeof LomeDataset>;
export type LpgMarketDataset = z.infer<typeof LpgMarketDataset>;
export type JetDataset = z.infer<typeof JetDataset>;
